...
(function (Y, z) {
    ...
    var qa = ca + "Delay", Ca = ca + "Duration", na = M + "Delay", Na = M + "Duration", Pa = z.$$minErr("ng"), ra = {
        ...
        }, Xa = {transitionDuration: Na, transitionDelay: na, animationDuration: Ca, animationDelay: qa}, Da, wa, s, Z, za,
        sa, Ea, ta, G, R, A, N;
    z.module("ngAnimate", [], function () {
        ...
        return {
            restrict: "A", transclude: "element", terminal: !0, priority: 550, link: function (b, c, d, f, k) {
                var e, Q;
        ...
        this.$get = ["$$rAF",
            "$rootScope", "$rootElement", "$document", "$$Map", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", "$$forceReflow", "$$isDocumentHidden", function (c, d, e, C, U, oa, H, u, t, I, da) {
                ...
                function q(a, J, w) {
                    ...
                    var n = Da(w), h = Ha(a), m = K(h), ia = m &&
                        m.parentNode, n = pa(n), q = new H, u = v();
                    ...
                    var x = 0 <= ["enter", "move", "leave"].indexOf(J), r = da(), P = r || O.get(m);
                    w = !P && y.get(m) || {};
                    var p = !!w.state;
                    ...
                    if (p) {
                        ...
                        if (f("cancel", r, w)) if (2 === w.state) w.runner.end(); else if (w.structural) w.close(); else return T(h, w, r), w.runner; else if (f("join", r, w)) if (2 === w.state) T(h, r, {}); else return Ua(t, h, x ? J : null, n), J = r.event = w.event, n = T(h, w, r), w.runner
                    } else T(h, r, {});
                    (p = r.structural) ||
        ...
        this.$get = [function () {
            return {
                cacheKey: function (b, d, f, k) {
                    ...
                    b[a] ? (b[a].total++, b[a].value = d) : b[a] = {total: 1, value: d, isValid: f}
                }
            }
        }]
        ...
        this.$get = ["$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$Map", "$$rAFScheduler", "$$animateCache", function (a, d, f, k, e, Q, L) {
            function x(a) {
                ...
                for (d = 0; d < a.length; d++) {
                    var da = a[d];
                    f.set(da.domNode, a[d] = {domNode: da.domNode, element: da.element, fn: da.fn, children: []})
                }
            ...
            return function (e,
                ...
                function I(a) {
                    var b = [], c = {};
                    s(a, function (a, d) {
                        var l = K(a.element), g = 0 <= ["enter", "move"].indexOf(a.event), l = a.structural ? t(l) : [];
                        if (l.length) {
                            var f = g ? "to" : "from";
                            s(l, function (a) {
                            ...
                            if (!g[E]) {
                                var I = g[E] = {
                                    structural: !0, beforeStart: function () {
                                        ...
                                        h.close();
                                        k.close()
                                    }, classes: da(h.classes, k.classes), from: h, to: k, anchors: []
                                };
                ...
                d.$$postDigest(function () {
                    ...
                    var d = I(b), g = [];
                    s(d, function (a) {
                        var b = a.from ? a.from.element : a.element, c = u.addClass,
                ...
                return function (a, b) {
                    ...
                    function F() {
                        ...
                        if (!P) if (l.parentNode) {
                            var e =
                                    function (a) {
                                        if (la) m && a && (m = !1, v()); else if (m = !a, r.animationDuration) if (a = xa(l, m), m) y.push(a); else {
                    ...
                    var y = [], O =
                        a.attr("class"), B = Qa(g), P, m, la, fa, A, W, G, D, R, J, w = [];
                    if (0 === g.duration || !Q.animations && !Q.transitions) return h();
                    var ja = g.event && Z(g.event) ? g.event.join(" ") : g.event, Y = ja && g.structural, n = "",
                        S = "";
                    Y ? n = $(ja, "ng-", !0) : ja && (n = ja);
                    ...
                    return {
                        $$willAnimate: !0, end: e, start: function () {
                            if (!P) return A = {end: e, cancel: L, resume: null, pause: null}, fa = new d(A), U(F), fa
                        }
                    }
                }
            }]
        ...
        this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document", function (a, c, d, f, k, e, Q) {
            ...
            function C(c, e, f) {
                ...
                function v() {
                    var c = L(f.attr("class") || ""), d = x(c, q), c = x(q, c), d = a(h, {
                        to: k(f),
                ...
                var F;
                c = function () {
                    var c = a(h, {addClass: "ng-anchor-out", delay: !0, from: k(e)});
            ...
            ["$injector", "$$AnimateRunner", "$$jqLite", function (b, c, d) {
                ...
                return function (a, b, d, x) {
                    ...
                    function z(a, b, d, f, e) {
                        ...
                        b.push(f);
                        if (a = a.apply(a,
                            b)) if (Ea(a.start) && (a = a.start()), a instanceof c) a.done(e); else if (Ea(a)) return a;
                        return N
                    }
...
//# sourceMappingURL=angular-animate.min-1.8.2.js.map