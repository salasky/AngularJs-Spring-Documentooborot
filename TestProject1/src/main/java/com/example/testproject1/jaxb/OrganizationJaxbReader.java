...
@Service
public class OrganizationJaxbReader {
    public List<Organization> getOrganization(){
        try {
            JAXBContext jaxbContext=JAXBContext.newInstance(Organizations.class);
            Unmarshaller u=jaxbContext.createUnmarshaller();
            FileReader reader=new FileReader("C:\\Users\\smigranov\\Desktop\\TestProject\\TestProject\\testrepo\\TestProject1\\src\\main\\resources\\organizations.xml");
