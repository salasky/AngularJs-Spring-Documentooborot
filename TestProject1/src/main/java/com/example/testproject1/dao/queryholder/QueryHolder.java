...
public class QueryHolder {
    ...
    public static final String TASK_DOCUMENT_GET_ALL_QUERY = new StringBuilder()
            ...
            .append("                    controlPerson.first_name AS person_control_id_first_name," )
            .append( "                    controlPerson.second_name AS person_control_id_second_name," )
            .append("                    controlPerson.last_name AS person_control_id_last_name," )
            .append("                    controlPerson.photo AS person_control_id_photo," )
            .append("                    controlPerson.phone_number AS person_control_id_phone_number," )
            .append("                    controlPerson.birth_day AS person_control_id_birth_day," )
